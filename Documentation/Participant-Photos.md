...
Zooom reads participant photos from the macOS Zoom Meeting SDK. This works in custom meeting UI and does not require a new REST API scope or access to another user’s account.
