...
> **Early preview.** [Download Yap 0.1.6](https://github.com/grinich/yap/releases/tag/v0.1.6). Zoom Marketplace review is still pending, so Zoom may restrict sign-in and external meetings. Google Calendar sign-in is in production but still unverified; Google’s warning and user limits apply until approval. Yap is independent, not affiliated with or endorsed by Zoom. [Availability details](Documentation/Distribution.md).
...
**Yap 0.1.6 (build 7)** requires **Apple silicon and macOS 26 or newer**. This release adds a menu-bar schedule, camera effects, native audio/video controls, expanded chat, group photos, and improvements to sharing, calendar-aware meetings, and playback. It retains the smaller Apple-silicon-only runtime.

Download [**Yap.dmg**](https://github.com/grinich/yap/releases/download/v0.1.6/Yap.dmg), open it, drag **Yap.app** to **Applications**, then launch Yap. [**Yap-macOS.zip**](https://github.com/grinich/yap/releases/download/v0.1.6/Yap-macOS.zip) is the alternative archive. The [release](https://github.com/grinich/yap/releases/tag/v0.1.6) includes matching SHA-256 files and the signed update feed. [Release notes](Documentation/ReleaseNotes/v0.1.6.md).
