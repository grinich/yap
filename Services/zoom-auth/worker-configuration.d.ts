/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: ae28fb02fa393bb6b04a7e2de322f448)
// Runtime types generated with workerd@1.20260907.1 2026-09-07 nodejs_compat
interface __BaseEnv_Env {
	REQUEST_LIMITER: RateLimit;
	SIGNATURE_LIMITER: RateLimit;
	ZOOM_PUBLIC_CLIENT_ID: string;
	ZOOM_OAUTH_CLIENT_ID: string;
	ZOOM_OAUTH_REDIRECT_URI: string;
	ZOOM_OAUTH_LEGACY_REDIRECT_URIS: string;
	ZOOM_SDK_CLIENT_ID: string;
	ZOOM_SDK_CLIENT_SECRET: string;
	SIGNING_GRANT_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ZOOM_PUBLIC_CLIENT_ID" | "ZOOM_OAUTH_CLIENT_ID" | "ZOOM_OAUTH_REDIRECT_URI" | "ZOOM_OAUTH_LEGACY_REDIRECT_URIS" | "ZOOM_SDK_CLIENT_ID" | "ZOOM_SDK_CLIENT_SECRET" | "SIGNING_GRANT_SECRET">> {}
}
