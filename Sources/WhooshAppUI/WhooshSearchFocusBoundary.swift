...
@MainActor
struct WhooshSearchFocusBoundary: NSViewRepresentable {
    var onOutsideClick: () -> Void

    func makeNSView(context: Context) -> WhooshSearchFocusBoundaryView {
        let view = WhooshSearchFocusBoundaryView()
        view.onOutsideClick = onOutsideClick
        return view
    }

    func updateNSView(_ view: WhooshSearchFocusBoundaryView, context: Context) {
        view.onOutsideClick = onOutsideClick
    }

    static func dismantleNSView(_ view: WhooshSearchFocusBoundaryView, coordinator: ()) {
        view.stop()
    }
}

@MainActor
final class WhooshSearchFocusBoundaryView: NSView {
    var onOutsideClick: () -> Void = {}
