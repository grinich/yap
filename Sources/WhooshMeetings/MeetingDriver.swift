...
public final class MissingZoomMeetingDriver: MeetingDriver {
    public static let setupMessage = "Live Zoom calls aren’t connected in this build. The current macOS Meeting SDK and your Zoom developer configuration are needed. You can explore Zooom using the clearly labeled demo."
