...
private actor ZoomOAuthLoopbackListener {
    ...
    private let queue = DispatchQueue(label: "app.whoosh.zoom-oauth-loopback")
    ...
    private func accept(_ connection: NWConnection) async {
        ...
        do {
            ...
            do {
                ...
                await respond(connection, status: "200 OK", message: "Connected. You can return to Zooom.")
                finish(.success(code))
            } catch ZoomAccountError.authorizationDenied {
                await respond(connection, status: "200 OK", message: "Zoom access was not granted. You can return to Zooom.")
