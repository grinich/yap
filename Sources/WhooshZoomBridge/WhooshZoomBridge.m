...
static os_log_t WHZoomConnectionLog(void) {
    ...
    dispatch_once(&once, ^{ log = os_log_create("app.whoosh.zoom", "connection"); });
    return log;
}
...
- (void)checkLeaveCompletion:(NSUInteger)revision session:(NSString *)session {
    ...
    if (elapsed >= 15 && !self.leaveWarningEmitted) {
        ...
        [self emit:@"controlError" object:@"Zoom hasn’t confirmed that it disconnected. Zooom is keeping the meeting session open and will keep checking."];
    }
    __weak typeof(self) weakSelf = self;
...
- (void)requestLeaveWithMessage:(NSString *)message endMeeting:(BOOL)end {
    ...
    if (message) [self emit:@"controlError" object:[message stringByAppendingString:@" Zooom is asking Zoom to disconnect before closing this meeting."]];
...
- (void)onZoomSDKAuthReturn:(ZoomSDKAuthError)result {
    ...
    // Whoosh supplies one accessible participant label and microphone indicator.
...
- (void)refreshIndicators {
    ...
    if ([self.appSignal canShowPanel]) [items addObject:@{@"id":@"whoosh.zoom.app-signal", @"title":@"Apps and privacy"}];
...
- (NSInteger)showMeetingIndicator:(NSString *)indicatorID {
    ...
    if ([indicatorID isEqualToString:@"whoosh.zoom.app-signal"] && self.appSignal) return [self.appSignal showPanel:point parentWindow:window];
...
- (void)onEndOtherMeetingToJoinMeetingNotification:(ZoomSDKError (^)(void))endOther actionCancel:(void (^)(void))cancel {
    ...
    // Starting Whoosh is not authorization to end a separate meeting.
...
- (void)onVirtualNameTagStatusChanged:(BOOL)bOn userID:(unsigned int)userID { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onVirtualNameTagRosterInfoUpdated:(unsigned int)userID { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onSpotlightVideoUserChange:(NSArray*_Nullable)spotlightedUserList { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onLowOrRaiseHandStatusChange:(BOOL)raise UserID:(unsigned int)userID { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onMultiToSingleShareNeedConfirm:(ZoomSDKMultiToSingleShareConfirmHandler*_Nullable)confirmHandle { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
...
- (void)onInvalidReclaimHostKey { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onHostVideoOrderUpdated:(NSArray*)orderList { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onLocalVideoOrderUpdated:(NSArray*)localOrderList { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onFollowHostVideoOrderChanged:(BOOL)follow { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onAllHandsLowered { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onUserVideoQualityChanged:(ZoomSDKVideoQuality)quality userID:(unsigned int)userID { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
...
- (void)onShareMeetingChatStatusChanged:(BOOL)isStart { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onSuspendParticipantsActivities { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onAllowParticipantsStartVideoNotification:(BOOL)allow { [self refreshParticipants]; }
- (void)onAllowParticipantsRenameNotification:(BOOL)allow { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onAllowParticipantsUnmuteSelfNotification:(BOOL)allow { [self refreshParticipants]; }
- (void)onAllowParticipantsShareWhiteBoardNotification:(BOOL)allow { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
...
- (void)onMeetingQAStatusChanged:(BOOL)isMeetingQAFeatureOn { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)notifyToJoin3rdPartyTelephonyAudio:(NSString*)audioInfo { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
...
- (void)onCameraControlRequestResult:(unsigned int)userId resultType:(ZoomSDKCameraControlRequestResult)resultType { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onMuteOnEntryStatusChange:(BOOL)enable { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onMeetingTopicChanged:(NSString *)topic { [self refreshParticipants]; }
- (void)onBotAuthorizerRelationChanged:(unsigned int)authorizeUserID { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onCreateCompanionRelation:(unsigned int)parentUserID childUserID:(unsigned int)childUserID { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onRemoveCompanionRelation:(unsigned int)childUserID { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onGrantCoOwnerPrivilegeChanged:(BOOL)canGrantOther { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onChatMessageEditNotification:(ZoomSDKChatInfo*)chatInfo { [self publishChat:chatInfo event:@"chatEdited"]; }
- (void)onFileSendStart:(ZoomSDKFileSender *)sender { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onFileReceived:(ZoomSDKFileReceiver *)receiver { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onFileTransferProgress:(ZoomSDKFileTransferInfo *)info { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onWaitingRoomPresetAudioStatusChanged:(BOOL)audioCanTurnOn { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onWaitingRoomPresetVideoStatusChanged:(BOOL)videoCanTurnOn { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onCustomWaitingRoomDataUpdated:(ZoomSDKCustomWaitingRoomData*_Nullable)bData handle:(ZoomSDKWaitingRoomDataDownloadHandler*_Nullable)handle { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onWaitingRoomEntranceEnabled:(BOOL)enabled { [self refreshWaitingRoom]; }
- (void)onRecord2MP4Done:(BOOL)success Path:(NSString*)recordPath { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onRecord2MP4Progressing:(int)percentage { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onRecordPrivilegeChange:(BOOL)canRec { [self refreshCloudRecording]; }
- (void)onCustomizedRecordingSourceReceived:(CustomizedRecordingLayoutHelper*)helper { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onLocalRecordingPrivilegeRequestStatus:(ZoomSDKRequestLocalRecordingStatus)status { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
- (void)onLocalRecordingPrivilegeRequested:(ZoomSDKRequestLocalRecordingPrivilegeHandler *_Nullable)handler { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
...
- (void)onRequestCloudRecordingResponse:(ZoomSDKRequestStartCloudRecordingStatus)status { /* This feature is not offered by Whoosh. No state or permission is changed. */ }
