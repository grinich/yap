...
struct RecordingTranscriptView: View {
        ...
        VStack(spacing: 6) {
            HStack(spacing: 6) {
                ...
                if !transcript.query.isEmpty {
                    ...
                    .buttonStyle(.plain).yapIconHover(cornerRadius: 6)
    ...
    private func cueRow(_ cue: ZoomRecordingTranscriptCue) -> some View {
        ...
        .overlay {
            RoundedRectangle(cornerRadius: 10)
                .strokeBorder(active || match ? YapTheme.accent.opacity(contrast == .increased ? 0.9 : 0.5) : .clear,
    ...
    private func footer(_ proxy: ScrollViewProxy) -> some View {
        VStack(spacing: 0) {
            ...
            HStack(spacing: 5) {
                ...
                .buttonStyle(.plain).yapIconHover(cornerRadius: 8)
                ...
                .yapIconHover(cornerRadius: 8).help("Download transcript").accessibilityLabel("Download transcript")
            }
