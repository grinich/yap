...
private struct YapIconHover: ViewModifier {
    let isSelected: Bool
...
extension View {
    ...
    func yapIconHover(isSelected: Bool = false, cornerRadius: CGFloat = 10) -> some View {
        modifier(YapIconHover(isSelected: isSelected, cornerRadius: cornerRadius))
    }
}
