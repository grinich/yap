...
/// Interactive controls retain tracking through YapWindowInteractionRegion.
struct YapWindowDragSurface: NSViewRepresentable {
    func makeNSView(context: Context) -> YapWindowDragView { YapWindowDragView() }
    func updateNSView(_ nsView: YapWindowDragView, context: Context) {}
}

@MainActor
class YapWindowDragView: NSView {
