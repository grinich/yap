...
public enum ZoomAccountError: LocalizedError, Sendable, Equatable {
    ...
    public var errorDescription: String? {
        ...
        case .invalidPublicConfiguration: "This Yap build has an incomplete Zoom sign-in configuration. Install the latest version."
        case .signingUnavailable: "Yap couldn’t reach its meeting authorization service. Please try again."
        ...
        case .localCallbackUnavailable: "Yap couldn’t open its local sign-in connection. Please try again."
        ...
        case .meetingCreationUnconfirmed: "Zoom did not confirm whether it created the meeting. Check your Zoom meetings before reconnecting and trying again; Yap has stopped automatic retries."
        case .keychain: "Yap couldn’t securely access your Zoom connection in Keychain."
        case .network: "Yap couldn’t reach Zoom. Check your connection and try again."
...
public actor KeychainZoomCredentialStore: ZoomCredentialStore {
    ...
    public init(service: String = "app.yap.zoom-personal", vault: CredentialVault = .shared) {
