...
Yap integrates the proprietary Zoom Meeting SDK for macOS. The SDK is obtained separately from Zoom and is not included in this source repository. Its use and redistribution are governed by [Zoom's API License and Terms of Use](https://www.zoom.com/en/trust/legal/zoom-api-license-and-tou/) and the SDK's accompanying notices. A license for Yap's own code does not grant rights to Zoom's SDK, trademarks, or service.
