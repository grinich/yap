...
private final class RevocationFixture {
    let suite = "WhooshRevocationTests.\(UUID())"
    ...
    init() {
        ...
        model = WhooshModel(preview: false, preferences: preferences, meeting: MeetingCoordinator(driver: DemoMeetingDriver()),
                            ...
                            reminders: WhooshReminderActions(requestAuthorization: { false }, synchronize: { _, _ in },
...
private actor RevocationCalendar: WhooshCalendarServing {
