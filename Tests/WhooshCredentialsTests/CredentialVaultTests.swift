...
import Testing
@testable import WhooshCredentials

@Suite("Consolidated credential access")
struct CredentialVaultTests {
    private let keys = [
        CredentialKey(service: "app.whoosh.personal.configuration", account: "google-desktop"),
        CredentialKey(service: "app.whoosh.google-calendar", account: "personal"),
        CredentialKey(service: "app.whoosh.zoom-personal", account: "configuration"),
        CredentialKey(service: "app.whoosh.zoom-personal", account: "oauth-tokens")
    ]
